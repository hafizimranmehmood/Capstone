...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Caller is not a current owner of the contract");
        _;
    }
...
contract Pausable is Ownable {
    ...
    function setPausable (bool paused) onlyOwner public {
        _paused = paused;
    }
    ...
    modifier paused() { 
        require (_paused, "Contract is still active"); 
        _; 
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Token owner should not approve himself to transfer his own tokens");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "You are not allowed to transfer this token");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "the given address do not owne the token");
        
        // TODO: require token is being transfered to valid address
        require(to != address(0), "can not transfer token to an invalid address");
